...
def gradient_projection(links, od_matrix, e):
    ...
    for od in od_matrix:
        ...
        so_od_matrix[od] = e * od_matrix[od]
        ue_od_matrix[od] = (1-e) * od_matrix[od]
    ...
    while cola < 300:
        ...
        for link in links:
            ...
            links[link]['marginal_travel_times'] = so_link_performance(links[link]['flow'], links[link]['capacity'],
                                                                       links[link]['free_flow_time'])
        ###################################
                ...
                if ue_od_matrix[od_pair] != 0:
                    ...
                    if len(Pi_ue[od_pair]) == 1:
                        ...
                        for i, pi in enumerate(Pi_ue[od_pair]):
                            ...
                            Pi_ue[od_pair][i][1] -= (c - cstar) / sd *0.98**cola
                            # print(c, cstar, sd)
                ...
                if so_od_matrix[od_pair] != 0:
                    ...
                    if len(Pi_so[od_pair]) == 1:
                        ...
                        for i, pi in enumerate(Pi_so[od_pair]):
                            ...
                            # print(Pi[od_pair][i][1])
                            Pi_so[od_pair][i][1] -= fd / sd * 0.95 ** cola
                            # print(c, cstar, sd)
...
for i in range(11):
    ...
    ttt, Pi_ue, Pi_so, links = gradient_projection(links, od_matrix, 0.3)
    print(Pi_ue[('1','15')])
    print(Pi_so[('1','15')])
    elog.append(ttt[len(ttt)-1])
    print(e, ttt[len(ttt)-1])
